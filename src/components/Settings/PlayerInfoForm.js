...
class Playerinfo extends PureComponent {
  ...
  onSubmit(e) {
    ...
    const formObj = [
      { name: this.refs.name1.value, bio: this.refs.bio1.value, city: this.refs.city1.value },
      { name: this.refs.name2.value, bio: this.refs.bio2.value, city: this.refs.city2.value },
    ];
